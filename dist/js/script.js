...

{
  ...
  class Cart{
    ...
    update(){
      ...
      //console.log('TP: ', thisCart.dom.productList);
    }
    remove(event){
      const thisCart = this;
    ...
    sendOrder(){
      ...
      fetch(url, options)
        .then(function(response){
          ...
          console.log('parRes: ', parsedResponse);
        });
    }
  }
  ...
  class CartProduct{
    ...
    getElements(element){
      ...
      thisCartProduct.dom.form = thisCartProduct.dom.wrapper.querySelector(select.cart.form);
    }
